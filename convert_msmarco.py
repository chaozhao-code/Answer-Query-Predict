...
#convert('/root/BiDAF/data/train_v1.1.json.gz', '/root/BiDAF/data/train.tsv', False)
convert('/root/BiDAF/data/dev_v1.1.json.gz', '/root/BiDAF/data/dev_test_100D.tsv', True)
#convert('/root/BiDAF/data/test_public_v1.1.json.gz', '/root/BiDAF/data/test.tsv', True)
